...
# Email input
email_input = st.text_area("Incoming Email:", height=200, key="email_input_box").strip()
...
recipient_name = st.text_input("Recipient Name", placeholder="e.g. John").strip()
sender_name = st.text_input("Your Name", placeholder="e.g. Myles").strip()
