...
<div class="flex items-start justify-between mb-6">
  ...
  <div class="relative">
    ...
    <div id="dropdown-menu" class="hidden absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg z-50">
      ...
      <a href="{{ url_for('proposals') }}" class="block px-4 py-2 hover:bg-gray-100">Proposals</a>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow text-center">
      <h3 class="text-sm text-gray-500 mb-1 font-medium tracking-wide">Plan Status</h3>
      <p class="text-xl font-semibold text-green-600 flex justify-center items-center gap-1">
        Active
    ...
    <!-- Automation Status -->
    <div class="bg-white p-6 rounded-lg shadow text-center">
      <h3 class="text-sm text-gray-500 mb-1 font-medium tracking-wide">Automation</h3>
      ...
      {% else %}
        <p class="text-xl font-semibold text-red-600 flex justify-center items-center gap-1">
          Not Configured
